...
---
## [Jenkins] Deploy Jenkins Server on Azure VM with Terraform {{ date: '2024-03-20T00:00Z' }}

Jenkins, an open-source automation server, plays a vital role in facilitating CI/CD pipelines. 
This project aims to automate the deployment of Jenkins on an Azure virtual machine (VM) using Terraform.
